            ...
            <div class="col m3 l3 s12 cont-menu">
                ...
                <div class="social">
                    <ul>
                        ...
                        <li>
                            <a href="https://www.youtube.com/channel/UC2Nlm415Wg2IRlNsgFNPJnw" target="_blank"><img id="ic_youtube" src="<?php bloginfo( 'template_directory' );?>/img/social/Y1_1024.png" alt="Youtube"></a>
                        </li>
                    </ul>
                </div>
            </div>
